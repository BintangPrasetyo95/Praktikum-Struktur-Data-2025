...
int main()
{
    ...
    do
    {
        ...
        {
            cout << "Cari successor dari: ";
            cin >> x;
            int ans;
            if (findSuccessor(root, x, ans))
                cout << "Successor: " << ans << "\n";
            else cout << "Tidak ada successor (mungkin kunci tidak ada atau yang terbesar)\n";
        }
        else if (pilih == 6)
        {
            cout << "Cari predecessor dari: ";
            cin >> x;
            int ans;
            if (findPredecessor(root, x, ans))
                cout << "Predecessor: " << ans
                     << "\n";
